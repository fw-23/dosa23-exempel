...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        System.out.println(Recursy.fastFib(60));
        System.out.println("--- slow fib:");
        ...
        String[] dwarves = {"Åäö", "Fili", "Kili", "Balin", "Dwalin", "Ori", "Nori", "Dori", "Gloin", "Oin", "Bifur", "Bofur", "Bombur", "Thorin"};
        ...
        for (int i = 0; i < dwarves.length; i++) {
            persons.add(new Person(dwarves[i], i));
        }
        ...
        Sorty sorty = new Sorty(dwarves);
        sorty.bubbleSort();
        sorty.bubbleSort();

        Sorty sorty2 = new Sorty(dwarves);
        sorty2.insertionSort();
        sorty2.insertionSort();

        Sorty names1 = new Sorty(topMaleNames);
        names1.bubbleSort();

        Sorty names2 = new Sorty(topMaleNames);
        names2.insertionSort();
